...
class CertificateManagerClient(metaclass=CertificateManagerClientMeta):
    ...
    def certificate_path(project: str,location: str,certificate: str,) -> str:
        ...
        return "projects/{project}/locations/{location}/certificates/{certificate}".format(project=project, location=location, certificate=certificate, )

    @staticmethod
    def parse_certificate_path(path: str) -> Dict[str,str]:
        """Parses a certificate path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/certificates/(?P<certificate>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def certificate_issuance_config_path(project: str,location: str,certificate_issuance_config: str,) -> str:
        """Returns a fully-qualified certificate_issuance_config string."""
        return "projects/{project}/locations/{location}/certificateIssuanceConfigs/{certificate_issuance_config}".format(project=project, location=location, certificate_issuance_config=certificate_issuance_config, )
    ...
    def parse_certificate_issuance_config_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/certificateIssuanceConfigs/(?P<certificate_issuance_config>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def certificate_map_path(project: str,location: str,certificate_map: str,) -> str:
        ...
        return "projects/{project}/locations/{location}/certificateMaps/{certificate_map}".format(project=project, location=location, certificate_map=certificate_map, )

    @staticmethod
    def parse_certificate_map_path(path: str) -> Dict[str,str]:
        """Parses a certificate_map path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/certificateMaps/(?P<certificate_map>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def certificate_map_entry_path(project: str,location: str,certificate_map: str,certificate_map_entry: str,) -> str:
        """Returns a fully-qualified certificate_map_entry string."""
        return "projects/{project}/locations/{location}/certificateMaps/{certificate_map}/certificateMapEntries/{certificate_map_entry}".format(project=project, location=location, certificate_map=certificate_map, certificate_map_entry=certificate_map_entry, )
    ...
    def parse_certificate_map_entry_path(path: str) -> Dict[str,str]:
        ...
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/certificateMaps/(?P<certificate_map>.+?)/certificateMapEntries/(?P<certificate_map_entry>.+?)$", path)
        return m.groupdict() if m else {}

    @staticmethod
    def dns_authorization_path(project: str,location: str,dns_authorization: str,) -> str:
        """Returns a fully-qualified dns_authorization string."""
        return "projects/{project}/locations/{location}/dnsAuthorizations/{dns_authorization}".format(project=project, location=location, dns_authorization=dns_authorization, )

    @staticmethod
    def parse_dns_authorization_path(path: str) -> Dict[str,str]:
        """Parses a dns_authorization path into its component segments."""
        m = re.match(r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/dnsAuthorizations/(?P<dns_authorization>.+?)$", path)
        return m.groupdict() if m else {}
    ...
    def list_certificate_maps(self,
    ...
    def create_certificate_map(self,
    ...
    def update_certificate_map(self,
    ...
    def delete_certificate_map(self,
    ...
    def list_certificate_map_entries(self,
            request: Union[certificate_manager.ListCertificateMapEntriesRequest, dict] = None,
            *,
            parent: str = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: float = None,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_certificate_map_entries]
    ...
    def get_certificate_map_entry(self,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_certificate_map_entry]
    ...
    def create_certificate_map_entry(self,
            request: Union[certificate_manager.CreateCertificateMapEntryRequest, dict] = None,
            *,
            parent: str = None,
        ...
        # Quick check: If we got a request object, we should *not* have
        # gotten any keyword arguments that map to the request.
        has_flattened_params = any([parent, certificate_map_entry, certificate_map_entry_id])
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_certificate_map_entry]
    ...
    def update_certificate_map_entry(self,
            request: Union[certificate_manager.UpdateCertificateMapEntryRequest, dict] = None,
            *,
            certificate_map_entry: certificate_manager.CertificateMapEntry = None,
            update_mask: field_mask_pb2.FieldMask = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.update_certificate_map_entry]
    ...
    def delete_certificate_map_entry(self,
            request: Union[certificate_manager.DeleteCertificateMapEntryRequest, dict] = None,
            *,
            name: str = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: float = None,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_certificate_map_entry]
    ...
    def list_dns_authorizations(self,
    ...
    def get_dns_authorization(self,
    ...
    def create_dns_authorization(self,
    ...
    def update_dns_authorization(self,
    ...
    def delete_dns_authorization(self,
    ...
    def list_certificate_issuance_configs(self,
            request: Union[certificate_issuance_config.ListCertificateIssuanceConfigsRequest, dict] = None,
            *,
            parent: str = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: float = None,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.list_certificate_issuance_configs]
    ...
    def get_certificate_issuance_config(self,
            request: Union[certificate_issuance_config.GetCertificateIssuanceConfigRequest, dict] = None,
            *,
            name: str = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: float = None,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_certificate_issuance_config]
    ...
    def create_certificate_issuance_config(self,
            request: Union[gcc_certificate_issuance_config.CreateCertificateIssuanceConfigRequest, dict] = None,
            *,
            parent: str = None,
        ...
        # Quick check: If we got a request object, we should *not* have
        # gotten any keyword arguments that map to the request.
        has_flattened_params = any([parent, certificate_issuance_config, certificate_issuance_config_id])
        if request is not None and has_flattened_params:
            raise ValueError('If the `request` argument is set, then none of '
                             'the individual field arguments should be set.')
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_certificate_issuance_config]
    ...
    def delete_certificate_issuance_config(self,
            request: Union[certificate_issuance_config.DeleteCertificateIssuanceConfigRequest, dict] = None,
            *,
            name: str = None,
            retry: OptionalRetry = gapic_v1.method.DEFAULT,
            timeout: float = None,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_certificate_issuance_config]
