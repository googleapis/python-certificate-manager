...
from .base import CertificateManagerTransport, DEFAULT_CLIENT_INFO
...
class CertificateManagerGrpcTransport(CertificateManagerTransport):
    ...
    def list_certificate_issuance_configs(self) -> Callable[
        ...
        if 'list_certificate_issuance_configs' not in self._stubs:
            self._stubs['list_certificate_issuance_configs'] = self.grpc_channel.unary_unary(
    ...
    def get_certificate_issuance_config(self) -> Callable[
        ...
        if 'get_certificate_issuance_config' not in self._stubs:
            self._stubs['get_certificate_issuance_config'] = self.grpc_channel.unary_unary(
    ...
    def create_certificate_issuance_config(self) -> Callable[
        ...
        if 'create_certificate_issuance_config' not in self._stubs:
            self._stubs['create_certificate_issuance_config'] = self.grpc_channel.unary_unary(
    ...
    def delete_certificate_issuance_config(self) -> Callable[
        ...
        if 'delete_certificate_issuance_config' not in self._stubs:
            self._stubs['delete_certificate_issuance_config'] = self.grpc_channel.unary_unary(
