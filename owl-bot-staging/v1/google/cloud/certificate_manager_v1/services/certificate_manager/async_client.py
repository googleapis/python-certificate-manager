...
class CertificateManagerAsyncClient:
    ...
    target_https_proxies_path = staticmethod(CertificateManagerClient.target_https_proxies_path)
    parse_target_https_proxies_path = staticmethod(CertificateManagerClient.parse_target_https_proxies_path)
    target_ssl_proxies_path = staticmethod(CertificateManagerClient.target_ssl_proxies_path)
    parse_target_ssl_proxies_path = staticmethod(CertificateManagerClient.parse_target_ssl_proxies_path)
