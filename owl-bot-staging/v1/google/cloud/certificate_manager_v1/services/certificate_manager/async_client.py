...
class CertificateManagerAsyncClient:
    """API Overview
    ...
    _client: CertificateManagerClient
    ...
    get_transport_class = functools.partial(type(CertificateManagerClient).get_transport_class, type(CertificateManagerClient))
    ...
    def __init__(self, *,
        ...
        """
        self._client = CertificateManagerClient(
...
initial=1.0,maximum=10.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def list_certificate_maps(self,
...
initial=1.0,maximum=10.0,multiplier=1.3,                predicate=retries.if_exception_type(
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__aiter__` convenience method.
        response = pagers.ListCertificateMapsAsyncPager(
            method=rpc,
            request=request,
            response=response,
            metadata=metadata,
    ...
    async def get_certificate_map(self,
...
initial=1.0,maximum=10.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def create_certificate_map(self,
...
initial=1.0,maximum=10.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def update_certificate_map(self,
...
initial=1.0,maximum=10.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def delete_certificate_map(self,
...
initial=1.0,maximum=10.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def list_certificate_map_entries(self,
...
initial=1.0,maximum=10.0,multiplier=1.3,                predicate=retries.if_exception_type(
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__aiter__` convenience method.
        response = pagers.ListCertificateMapEntriesAsyncPager(
            method=rpc,
            request=request,
            response=response,
            metadata=metadata,
    ...
    async def get_certificate_map_entry(self,
...
initial=1.0,maximum=10.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def create_certificate_map_entry(self,
        ...
        Args:
            ...
            certificate_map_entry (:class:`google.cloud.certificate_manager_v1.types.CertificateMapEntry`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            certificate_map_entry_id (:class:`str`):
                Required. A user-provided name of the
...
initial=1.0,maximum=10.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def update_certificate_map_entry(self,
...
initial=1.0,maximum=10.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def delete_certificate_map_entry(self,
...
initial=1.0,maximum=10.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def list_dns_authorizations(self,
...
initial=1.0,maximum=10.0,multiplier=1.3,                predicate=retries.if_exception_type(
        ...
        # This method is paged; wrap the response in a pager, which provides
        # an `__aiter__` convenience method.
        response = pagers.ListDnsAuthorizationsAsyncPager(
            method=rpc,
            request=request,
            response=response,
            metadata=metadata,
    ...
    async def get_dns_authorization(self,
...
initial=1.0,maximum=10.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def create_dns_authorization(self,
        ...
        Args:
            ...
            dns_authorization (:class:`google.cloud.certificate_manager_v1.types.DnsAuthorization`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            dns_authorization_id (:class:`str`):
                Required. A user-provided name of the
                dns authorization.
...
initial=1.0,maximum=10.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def update_dns_authorization(self,
...
initial=1.0,maximum=10.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def delete_dns_authorization(self,
...
initial=1.0,maximum=10.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def list_certificate_issuance_configs(self,
...
initial=1.0,maximum=10.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def get_certificate_issuance_config(self,
...
initial=1.0,maximum=10.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def create_certificate_issuance_config(self,
...
initial=1.0,maximum=10.0,multiplier=1.3,                predicate=retries.if_exception_type(
    ...
    async def delete_certificate_issuance_config(self,
