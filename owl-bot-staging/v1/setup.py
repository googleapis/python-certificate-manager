...
description = "Google Cloud Certificate Manager API client library"

version = {}
with open(os.path.join(package_root, 'google/cloud/certificate_manager/gapic_version.py')) as fp:
