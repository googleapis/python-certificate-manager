...
from google.cloud.certificate_manager_v1.services.certificate_manager import CertificateManagerAsyncClient
from google.cloud.certificate_manager_v1.services.certificate_manager import CertificateManagerClient
...
@pytest.mark.parametrize("client_class,transport_class,transport_name", [
    ...
    (CertificateManagerAsyncClient, transports.CertificateManagerGrpcAsyncIOTransport, "grpc_asyncio"),
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,use_client_cert_env", [
    (CertificateManagerClient, transports.CertificateManagerGrpcTransport, "grpc", "true"),
    (CertificateManagerAsyncClient, transports.CertificateManagerGrpcAsyncIOTransport, "grpc_asyncio", "true"),
    (CertificateManagerClient, transports.CertificateManagerGrpcTransport, "grpc", "false"),
    (CertificateManagerAsyncClient, transports.CertificateManagerGrpcAsyncIOTransport, "grpc_asyncio", "false"),
    (CertificateManagerClient, transports.CertificateManagerRestTransport, "rest", "true"),
    (CertificateManagerClient, transports.CertificateManagerRestTransport, "rest", "false"),
])
@mock.patch.object(CertificateManagerClient, "DEFAULT_ENDPOINT", modify_default_endpoint(CertificateManagerClient))
@mock.patch.object(CertificateManagerAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(CertificateManagerAsyncClient))
...
@pytest.mark.parametrize("client_class", [
    CertificateManagerClient, CertificateManagerAsyncClient
])
@mock.patch.object(CertificateManagerClient, "DEFAULT_ENDPOINT", modify_default_endpoint(CertificateManagerClient))
@mock.patch.object(CertificateManagerAsyncClient, "DEFAULT_ENDPOINT", modify_default_endpoint(CertificateManagerAsyncClient))
...
@pytest.mark.parametrize("client_class,transport_class,transport_name,grpc_helpers", [
    (CertificateManagerClient, transports.CertificateManagerGrpcTransport, "grpc", grpc_helpers),
    (CertificateManagerAsyncClient, transports.CertificateManagerGrpcAsyncIOTransport, "grpc_asyncio", grpc_helpers_async),
    (CertificateManagerClient, transports.CertificateManagerRestTransport, "rest", None),
])
...
def test_list_certificates_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        assert all(isinstance(i, certificate_manager.Certificate)
                   for i in results)
...
async def test_list_certificates_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_certificates(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_get_certificate(request_type, transport: str = 'grpc'):
    ...
    with mock.patch.object(
        ...
        call.return_value = certificate_manager.Certificate(
            ...
            self_managed=certificate_manager.Certificate.SelfManagedCertificate(pem_certificate='pem_certificate_value'),
        )
...
def test_delete_certificate(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_certificate),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_list_certificate_maps_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, certificate_manager.CertificateMap)
                   for i in results)
...
async def test_list_certificate_maps_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_certificate_maps(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_get_certificate_map(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_certificate_map),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_certificate_map(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_certificate_map),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_update_certificate_map(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_certificate_map),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_certificate_map(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_certificate_map),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_list_certificate_map_entries_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, certificate_manager.CertificateMapEntry)
                   for i in results)
...
async def test_list_certificate_map_entries_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_certificate_map_entries(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_get_certificate_map_entry(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_certificate_map_entry),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_certificate_map_entry(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_certificate_map_entry),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_create_certificate_map_entry_flattened():
    ...
    with mock.patch.object(
        ...
        client.create_certificate_map_entry(
            parent='parent_value',
            certificate_map_entry=certificate_manager.CertificateMapEntry(name='name_value'),
...
def test_update_certificate_map_entry(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_certificate_map_entry),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_certificate_map_entry(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_certificate_map_entry),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_list_dns_authorizations_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, certificate_manager.DnsAuthorization)
                   for i in results)
...
async def test_list_dns_authorizations_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_dns_authorizations(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_get_dns_authorization(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_dns_authorization),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_dns_authorization(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_dns_authorization),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_update_dns_authorization(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.update_dns_authorization),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_delete_dns_authorization(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_dns_authorization),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_list_certificate_issuance_configs_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(
        ...
        results = list(pager)
        assert len(results) == 6
        assert all(isinstance(i, certificate_issuance_config.CertificateIssuanceConfig)
                   for i in results)
...
async def test_list_certificate_issuance_configs_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_certificate_issuance_configs(request={})).pages: # pragma: no branch
            pages.append(page_)
        for page_, token in zip(pages, ['abc','def','ghi', '']):
            assert page_.raw_page.next_page_token == token
...
def test_get_certificate_issuance_config(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.get_certificate_issuance_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
...
def test_create_certificate_issuance_config(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.create_certificate_issuance_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_create_certificate_issuance_config_flattened():
    ...
    with mock.patch.object(
        ...
        client.create_certificate_issuance_config(
            parent='parent_value',
            certificate_issuance_config=gcc_certificate_issuance_config.CertificateIssuanceConfig(name='name_value'),
...
def test_delete_certificate_issuance_config(request_type, transport: str = 'grpc'):
    ...
    # Mock the actual call within the gRPC stub, and fake the request.
    with mock.patch.object(
            type(client.transport.delete_certificate_issuance_config),
            '__call__') as call:
        # Designate an appropriate return value for the call.
        call.return_value = operations_pb2.Operation(name='operations/spam')
...
def test_list_certificates_rest_interceptors(null_interceptor):
    transport = transports.CertificateManagerRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None if null_interceptor else transports.CertificateManagerRestInterceptor(),
        )
    client = CertificateManagerClient(transport=transport)
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.CertificateManagerRestInterceptor, "post_list_certificates") as post, \
         mock.patch.object(transports.CertificateManagerRestInterceptor, "pre_list_certificates") as pre:
...
def test_get_certificate_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.CertificateManagerRestInterceptor, "post_get_certificate") as post, \
         mock.patch.object(transports.CertificateManagerRestInterceptor, "pre_get_certificate") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_certificate_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         ...
         mock.patch.object(transports.CertificateManagerRestInterceptor, "post_create_certificate") as post, \
         mock.patch.object(transports.CertificateManagerRestInterceptor, "pre_create_certificate") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_certificate_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.CertificateManagerRestInterceptor, "post_update_certificate") as post, \
         mock.patch.object(transports.CertificateManagerRestInterceptor, "pre_update_certificate") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_certificate_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.CertificateManagerRestInterceptor, "post_delete_certificate") as post, \
         mock.patch.object(transports.CertificateManagerRestInterceptor, "pre_delete_certificate") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_certificate_maps_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = certificate_manager.ListCertificateMapsResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_list_certificate_maps_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.CertificateManagerRestInterceptor, "post_list_certificate_maps") as post, \
         mock.patch.object(transports.CertificateManagerRestInterceptor, "pre_list_certificate_maps") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_certificate_map_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.CertificateManagerRestInterceptor, "post_get_certificate_map") as post, \
         mock.patch.object(transports.CertificateManagerRestInterceptor, "pre_get_certificate_map") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_certificate_map_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.CertificateManagerRestInterceptor, "post_create_certificate_map") as post, \
         mock.patch.object(transports.CertificateManagerRestInterceptor, "pre_create_certificate_map") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_certificate_map_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.CertificateManagerRestInterceptor, "post_update_certificate_map") as post, \
         mock.patch.object(transports.CertificateManagerRestInterceptor, "pre_update_certificate_map") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_certificate_map_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.CertificateManagerRestInterceptor, "post_delete_certificate_map") as post, \
         mock.patch.object(transports.CertificateManagerRestInterceptor, "pre_delete_certificate_map") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_certificate_map_entries_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = certificate_manager.ListCertificateMapEntriesResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_list_certificate_map_entries_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.CertificateManagerRestInterceptor, "post_list_certificate_map_entries") as post, \
         mock.patch.object(transports.CertificateManagerRestInterceptor, "pre_list_certificate_map_entries") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_certificate_map_entry_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.CertificateManagerRestInterceptor, "post_get_certificate_map_entry") as post, \
         mock.patch.object(transports.CertificateManagerRestInterceptor, "pre_get_certificate_map_entry") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_certificate_map_entry_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.CertificateManagerRestInterceptor, "post_create_certificate_map_entry") as post, \
         mock.patch.object(transports.CertificateManagerRestInterceptor, "pre_create_certificate_map_entry") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_certificate_map_entry_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.CertificateManagerRestInterceptor, "post_update_certificate_map_entry") as post, \
         mock.patch.object(transports.CertificateManagerRestInterceptor, "pre_update_certificate_map_entry") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_certificate_map_entry_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.CertificateManagerRestInterceptor, "post_delete_certificate_map_entry") as post, \
         mock.patch.object(transports.CertificateManagerRestInterceptor, "pre_delete_certificate_map_entry") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_dns_authorizations_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = certificate_manager.ListDnsAuthorizationsResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_list_dns_authorizations_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.CertificateManagerRestInterceptor, "post_list_dns_authorizations") as post, \
         mock.patch.object(transports.CertificateManagerRestInterceptor, "pre_list_dns_authorizations") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_dns_authorization_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.CertificateManagerRestInterceptor, "post_get_dns_authorization") as post, \
         mock.patch.object(transports.CertificateManagerRestInterceptor, "pre_get_dns_authorization") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_dns_authorization_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.CertificateManagerRestInterceptor, "post_create_dns_authorization") as post, \
         mock.patch.object(transports.CertificateManagerRestInterceptor, "pre_create_dns_authorization") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_update_dns_authorization_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.CertificateManagerRestInterceptor, "post_update_dns_authorization") as post, \
         mock.patch.object(transports.CertificateManagerRestInterceptor, "pre_update_dns_authorization") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_dns_authorization_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.CertificateManagerRestInterceptor, "post_delete_dns_authorization") as post, \
         mock.patch.object(transports.CertificateManagerRestInterceptor, "pre_delete_dns_authorization") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_list_certificate_issuance_configs_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = certificate_issuance_config.ListCertificateIssuanceConfigsResponse.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_list_certificate_issuance_configs_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.CertificateManagerRestInterceptor, "post_list_certificate_issuance_configs") as post, \
         mock.patch.object(transports.CertificateManagerRestInterceptor, "pre_list_certificate_issuance_configs") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_get_certificate_issuance_config_rest(request_type):
    ...
    with mock.patch.object(type(client.transport._session), 'request') as req:
        ...
        response_value = Response()
        response_value.status_code = 200
        pb_return_value = certificate_issuance_config.CertificateIssuanceConfig.pb(return_value)
        json_return_value = json_format.MessageToJson(pb_return_value)
...
def test_get_certificate_issuance_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(transports.CertificateManagerRestInterceptor, "post_get_certificate_issuance_config") as post, \
         mock.patch.object(transports.CertificateManagerRestInterceptor, "pre_get_certificate_issuance_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_create_certificate_issuance_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.CertificateManagerRestInterceptor, "post_create_certificate_issuance_config") as post, \
         mock.patch.object(transports.CertificateManagerRestInterceptor, "pre_create_certificate_issuance_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_delete_certificate_issuance_config_rest_interceptors(null_interceptor):
    ...
    with mock.patch.object(type(client.transport._session), "request") as req, \
         mock.patch.object(path_template, "transcode")  as transcode, \
         mock.patch.object(operation.Operation, "_set_result_from_operation"), \
         mock.patch.object(transports.CertificateManagerRestInterceptor, "post_delete_certificate_issuance_config") as post, \
         mock.patch.object(transports.CertificateManagerRestInterceptor, "pre_delete_certificate_issuance_config") as pre:
        pre.assert_not_called()
        post.assert_not_called()
...
def test_certificate_manager_host_no_port(transport_name):
    client = CertificateManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='certificatemanager.googleapis.com'),
         transport=transport_name,
    )
    assert client.transport._host == (
        'certificatemanager.googleapis.com:443'
...
def test_certificate_manager_host_with_port(transport_name):
    client = CertificateManagerClient(
        credentials=ga_credentials.AnonymousCredentials(),
        client_options=client_options.ClientOptions(api_endpoint='certificatemanager.googleapis.com:8000'),
        transport=transport_name,
    )
    assert client.transport._host == (
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.CertificateManagerGrpcTransport, transports.CertificateManagerGrpcAsyncIOTransport])
def test_certificate_manager_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
...
@pytest.mark.parametrize("client_class,transport_class", [
    ...
    (CertificateManagerAsyncClient, transports.CertificateManagerGrpcAsyncIOTransport),
])
