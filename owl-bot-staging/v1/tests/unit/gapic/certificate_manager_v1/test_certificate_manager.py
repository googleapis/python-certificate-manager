...
def test_target_https_proxies_path():
    ...
    expected = "projects/{project}/locations/{location}/targetHttpsProxies/{targetHttpsProxy}".format(project=project, location=location, targetHttpsProxy=targetHttpsProxy, )
    actual = CertificateManagerClient.target_https_proxies_path(project, location, targetHttpsProxy)
    assert expected == actual
...
def test_target_ssl_proxies_path():
    ...
    expected = "projects/{project}/locations/{location}/targetSslProxies/{targetSslProxy}".format(project=project, location=location, targetSslProxy=targetSslProxy, )
    actual = CertificateManagerClient.target_ssl_proxies_path(project, location, targetSslProxy)
    assert expected == actual
