...
def test_target_https_proxies_path():
    ...
    expected = "projects/{project}/locations/{location}/targetHttpsProxies/{target_https_proxy}".format(project=project, location=location, target_https_proxy=target_https_proxy, )
    actual = CertificateManagerClient.target_https_proxies_path(project, location, target_https_proxy)
    assert expected == actual
...
def test_target_ssl_proxies_path():
    ...
    expected = "projects/{project}/locations/{location}/targetSslProxies/{target_ssl_proxy}".format(project=project, location=location, target_ssl_proxy=target_ssl_proxy, )
    actual = CertificateManagerClient.target_ssl_proxies_path(project, location, target_ssl_proxy)
    assert expected == actual
